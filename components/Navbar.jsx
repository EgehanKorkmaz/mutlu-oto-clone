      ...
      <div className="container mx-auto flex h-20 items-center justify-between px-4 md:px-8">
        ...
        <div className="hidden md:flex">
          <a
            ...
            className="flex items-center gap-2 rounded-md bg-[rgb(212,68,57)] px-6 py-2.5 text-sm font-medium text-white transition-all hover:bg-[rgb(190,55,45)] shadow-sm hover:shadow"
          >
