          ...
          {services.map((service, index) => {
            ...
            return (
              <motion.div
                ...
                className={`bg-white p-8 rounded-2xl shadow-sm border border-slate-100 hover:shadow-md hover:border-red-100 transition-colors transition-shadow group ${isLeftColumn ? "lg:col-span-2" : "lg:col-span-2"
                  }`}
              >
